...
公開中のアプリ実装コミット（試作60）: `3ccfbaa` (`Publish mobile60 hide video play button and auto resume playback`)

現行公開版: `試作60 / mobile60`（WebKitメディアコントロール完全非表示とタッチ即時再生復帰）

現行ローカル改善版: `試作61 / mobile61`（SHORTネイルの長さを自爪に自然に沿う短さへ調整）

アプリ実装コミット: 試作61をローカルで実装中
ブランチ: `main`
...
## 44. SHORTネイルの長さを短く調整（試作61・ローカル改善）
